...
public void setup_func_buttons(int x, int y) {
  Button b = cP5.addButton("FILE",1,x,y,(int)(190*0.33),20);  
  b.captionLabel().setSize(10);
  b.captionLabel().style().marginLeft = 20;
  b = cP5.addButton("PAUSE/RESUME",1,x+(int)(200*0.33),y,(int)(190*0.33),20);  
  b.captionLabel().setSize(10);
  b.captionLabel().style().marginLeft = 0;
  b = cP5.addButton("CANCEL",1,x+(int)(200*0.66),y,(int)(190*0.33),20);    
  b.captionLabel().setSize(10);
