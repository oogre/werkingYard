...
import jogamp.opengl.openal.av.*; 
...
import javax.media.opengl.glu.gl2es1.*; 
...
public void setup() {
  ...
  setup_port_selector(30,40,170,130); 
}
...
//    println(", value : "+theEvent.controller().value());
    ...
    // send file button
    if(theEvent.controller().name() == "FILE") {
...
public void setup_console(int x1, int y1, int x2, int y2) {
  ...
  cP5.addTextlabel("Y_POS","", (int)(x1 + x2 *0.5f)-20, y1+y2 + 10);
...
public void update_console() {
  ...
  for (int i=0; i<idx.size(); i++) {
    ((Textlabel)cP5.controller(idx.strVal[i]+"_POS")).setVisible(DEBUG ? true : PortResponding);
    ((Textlabel)cP5.controller(idx.strVal[i]+"_POS")).setValue(idx.strVal[i]+floatCoord(position[i]));
  }
  if (port == null || SendingSequence && !Paused) { cP5.controller("GCODE").setVisible(DEBUG ? true : false); } 
  else { 
...
public void setup_toggles(int x, int y) {
  ...
  t = cP5.addToggle("paused_LED",false,x+70,y,14,14);
  t.setLabel("PAUSED");
  t.captionLabel().style().marginTop = -14;
  t.captionLabel().style().marginLeft = 18;
  t.setLock(true);
  ...
  t = cP5.addToggle("waiting_LED",false,x+140,y,14,14);
  t.setLabel("WAITING");
  t.captionLabel().style().marginTop = -14;
  t.captionLabel().style().marginLeft = 18;
  t.setLock(true);
  ...
  t = cP5.addToggle("absolute_mode",false,x,y+20,14,14);
  t.setLabel("ABSOLUTE");
  t.captionLabel().style().marginTop = -14;
  t.captionLabel().style().marginLeft = 18;
//  t.setLock(true);
...
public void update_toggles() {
  // set visibility
  cP5.controller("sending_LED").setVisible(DEBUG ? true : PortResponding);
  cP5.controller("paused_LED").setVisible(DEBUG ? true : PortResponding);
  cP5.controller("waiting_LED").setVisible(DEBUG ? true : PortResponding);
  cP5.controller("absolute_mode").setVisible(DEBUG ? true : PortResponding);
  //cP5.controller("inch_mode").setVisible(DEBUG ? true : PortResponding);
...
public void update_port_selector() {
  ((DropdownList)cP5.group("PORT")).setVisible(DEBUG ? true : !SendingSequence);
  //((DropdownList)cP5.group("BAUD")).setVisible(DEBUG ? true : !SendingSequence);
}

// buttons

public void setup_func_buttons(int x, int y) {
  Button b = cP5.addButton("FILE",1,x,y,(int)(190*0.33f),20);  
  b.captionLabel().setSize(10);
  b.captionLabel().style().marginLeft = 20;
  b = cP5.addButton("PAUSE/RESUME",1,x+(int)(200*0.33f),y,(int)(190*0.33f),20);  
  b.captionLabel().setSize(10);
  b.captionLabel().style().marginLeft = 0;
  b = cP5.addButton("CANCEL",1,x+(int)(200*0.66f),y,(int)(190*0.33f),20);    
  b.captionLabel().setSize(10);
...
public void update_func_buttons() {
  if (!PortResponding) {
    cP5.controller("FILE").setVisible(DEBUG ? true : false);
    cP5.controller("PAUSE/RESUME").setVisible(DEBUG ? true : false);
    cP5.controller("CANCEL").setVisible(DEBUG ? true : false);
    return;
  }
  cP5.controller("FILE").setVisible(!SendingSequence);
...
public void setup_jog_buttons(int x, int y) {  
  ...
  Toggle t = cP5.addToggle("arc_mode",false, pos.x, pos.y, buttonWidth, buttonHeight);
  t.setLabel("ARCS");
  ...
  t = cP5.addToggle("xyz_mode",false, pos.x, pos.y, buttonWidth, buttonHeight);
  t.setLabel("XYZ");
  t.captionLabel().style().marginTop = -31;
  t.captionLabel().style().marginLeft = 14;
  t.captionLabel().getFont().setSize(14);
  ...
  pos.x += buttonmargin+buttonWidth;
  t = cP5.addToggle("zero_mode",false, pos.x, pos.y, buttonWidth, buttonHeight);
  t.setLabel("ZERO");
  t.captionLabel().style().marginTop = -31;
  t.captionLabel().style().marginLeft = 14;
  t.captionLabel().getFont().setSize(14);
...
*/
  ...
  Button b = cP5.addButton("X+", 1, (int)(pos.x), (int)(pos.y), buttonWidth, buttonHeight);
  b.captionLabel().style().marginTop = 10;
  b.captionLabel().style().marginLeft = 3;
  b.captionLabel().getFont().setSize(14); 
  
  pos.x += buttonmargin+buttonWidth;
  b=cP5.addButton("Y+", 1, (int)(pos.x), (int)(pos.y), buttonWidth, buttonHeight);
  b.captionLabel().style().marginTop = 10;
  b.captionLabel().style().marginLeft = 3;
  b.captionLabel().getFont().setSize(14);

  pos.x += buttonmargin+buttonWidth;
  b=cP5.addButton("Z+", 1, (int)(pos.x), (int)(pos.y), buttonWidth, buttonHeight);
  b.captionLabel().style().marginTop = 10;
  b.captionLabel().style().marginLeft = 3;
  b.captionLabel().getFont().setSize(14);
  ...
  b=cP5.addButton("X-", 1, (int)(pos.x), (int)(pos.y), buttonWidth, buttonHeight);
  b.captionLabel().style().marginTop = 10;
  b.captionLabel().style().marginLeft = 3;
  b.captionLabel().getFont().setSize(14); 
...
/*
  ...
  */
  for (int i = 0; i < jog_buttons.length; i++){
   ((Button)cP5.controller(jog_buttons[i])).activateBy(ControlP5.PRESSED);
  }
}  
...
public void update_jog_buttons() {
 ...
 // if ((int)cP5.controller("mem_mode").value() != (MemMode? 1:0)) cP5.controller("mem_mode").setValue((MemMode? 1:0));
  ...
  for (int i = 0; i < jog_buttons.length; i++) cP5.controller(jog_buttons[i]).setVisible(DEBUG ? true : Visible);
  for (int i = 0; i < jog_toggles.length; i++) cP5.controller(jog_toggles[i]).setVisible(DEBUG ? true : Visible);
...
public void setup_jog_controls(int x, int y, int y_off) { 
  ...
  g.getCaptionLabel().style().marginTop=5;
  x = 0;
  y = y_off;
/*
...
public void update_jog_controls() {
  Jogging_grp.setVisible(DEBUG ? true : PortResponding && (!SendingSequence || SendingSequence && Paused));
...
public void update_homing_controls() { 
  Homing_grp.setVisible(DEBUG ? true : PortResponding && (!SendingSequence || SendingSequence && Paused));
...
public void update_arc_controls() {
  Arcs_grp.setVisible(DEBUG ? true : PortResponding && (!SendingSequence || SendingSequence && Paused));
  if (UI_ReloadArcTF) {
    ((Textfield)cP5.controller("ARC_RADIUS")).setText(String.valueOf(arc_radius));
    ((Textfield)cP5.controller("ARC_START")).setText(String.valueOf(arc_start));
    ((Textfield)cP5.controller("ARC_END")).setText(String.valueOf(arc_end));
...
public void update_setting_controls() {
  Setting_grp.setVisible(DEBUG ? true : PortResponding && (!SendingSequence || SendingSequence && Paused));
